...
22 23 ." sound "          thru cr                               
24 28 thru 30 32 ." utilities "      thru cr                    
...
: dump 0 base @ >r hex                                          
 ...
 drop cr r> base ! ;                                            
decimal                                                         
( utilities: 'title title triad ) exit                          
variable 'title                                                 
: title  cr 11 spaces                                           
   ." chipwits c-64 development" cr ;                           
...
: sm   ( fr-scr fr-line --- )                                   
   >r >r   scr @   r# @   r@ i' sc                              
   r> scr !   r> x  r# !   scr ! ;                              
forth definitions : list list [compile] editor ;                
...
60 tempo ! 1/4                                                  
( music edit: ndef next.note ready ncalc )                      
: ndef create ( --- ) 12 allot                                  
   does> ( --- addr )                                           
    voice @ 2* 2* + ;                                           
...
LCal┌▁┌FFv▒C▄gD▝#▄▒C┌C
init.chipwitS ┬┌▌@c▔G
fF"V!@fS@▌fyfWbuO2""V▝D$D2a-@96&a@96a-@96a[@
962a!@96>a!@96pj)YC▄vHJC▄S┌▁┌L,WbIrJq"WbIrJqCstat.poin
tSM┬┌Ctoo.baD[┤┌D$D2I┤CendgamEM┤┌$D▄VD▝#D$D2I┤
Vja7              a5              
a6              a8              
cb              cwed            ;
